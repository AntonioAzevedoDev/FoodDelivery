                ...
                <div class="col-md-7 col-md-offset-1 col-sm-12 col-xs-12">
                    ...
                    <h3 class="price-container">
                        ...
                        <?php if (isset($extras)): ?>
                            ...
                            <div class="radio">
                                <label style="font-size: 16px">
                                    <input style="margin-top: 2px" type="radio" name="extra" class="extra" checked="" >Sem extra
                                </label>
                            </div>
                            ...
                            <?php foreach ($extras as $extra): ?>
                                <div class="radio">
                                    <label style="font-size: 16px">
                                        <input style="margin-top: 2px" type="radio" class="extra" data-extra="<?php echo $extra->id_principal ?>" 
