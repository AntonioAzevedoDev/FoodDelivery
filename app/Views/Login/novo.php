            ...
            <div class="col-md-12">
                ...
                <?php echo form_open('login/criar') ?>
                    <div class="form-group">
                        <input type="email" name="email" value="<?php echo old('email'); ?>" class="form-control" id="exampleInputEmail1" placeholder="Digite o seu email">
                    </div>
                    <div class="form-group">
                        <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="Digite a sua senha">
                    </div>
                    <div class="mt-3">
                        <button type="submit" class="btn btn-block btn-food" href="../../index.html">Entrar</button>
                    </div>
