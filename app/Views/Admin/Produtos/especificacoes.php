            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label for="medida_id">Escolha o medida do produto (opcional) <a href="javascript:void" class="" data-toggle="popover" title="Medida do produto" data-content="Exemplo de uso para pizza: <br>Pizza Grande, <br>Pizza Média, <br>Pizza Família">Entenda</a></label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="customizavel">Produto customizável <a href="javascript:void" class="" data-toggle="popover" title="Produto meio a meio" data-content="Exemplo de uso para pizza: <br>Metade calabresa e metade frango com catupiry">Entenda</a></label>
                ...
                <a href="<?php echo site_url("admin/produtos/show/$produto->id"); ?>" class="btn btn-light mt-4 text-dark btn-">
