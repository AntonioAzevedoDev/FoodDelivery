        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Atenção!</strong> Tem certeza da exclusão da especificação do produto ?
                ...
                <a href="<?php echo site_url("admin/produtos/especificacoes/$especificacao->produto_id"); ?>" class="btn btn-light text-dark btn-">
