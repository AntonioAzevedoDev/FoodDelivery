        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <?php else: ?>
                        <img class="card-img-top w-75"  src="<?php echo site_url('admin/images/produto-sem-imagem.webp') ?>" alt="Produto sem imagem por enquanto">
                    <?php endif; ?>
                </div>
                <?php if ($produto->deletado_em == null): ?>
                    <hr>
                    <a href = "<?php echo site_url("admin/produtos/editarImagem/$produto->id"); ?>" class = "btn btn-outline-primary mb-2 mt-2 btn-sm ">
