            ...
            <div class="card-body">
                ...
                <?php if ($forma->id == 1): ?>
                    <div class="alert alert-primary" role="alert"> 
                        ...
                        não pode ser <span class="text-danger">editada ou excluída</span>, pois essa
                        opção terá vinculada ou não o envio de troco para o comprador quando o mesmo estiver no 
