    ...
    public function adicionar() {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($especificacaoProduto == null) {
                ...
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-PROD-1001</strong>');
            }
            if ($produtoPost['extra_id'] && $produtoPost['extra_id'] != "") {
                ...
                if ($extra == null) {
                    ...
                    return redirect()->back()
                                    ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-PROD-2002</strong>');
                }
            }
            ...
            if ($produto == null || $produto->ativo == false) {
                ...
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-PROD-3003</strong>');
            }
    ...
    public function especial() {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($primeiroProduto == null) {
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-CUSTOM-1001</strong>');
            }
            ...
            if ($segundoProduto == null) {
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-CUSTOM-2002</strong>');
            }
            ...
            if ($produtoPost['extra_id'] && $produtoPost['extra_id'] != "") {
                ...
                if ($extra == null) {
                    ...
                    return redirect()->back()
                                    ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-CUSTOM-3003</strong>');
                }
            }
            ...
            if ($medida->preco == null) {
                ...
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ADD-CUSTOM-4004</strong>');
            }
    ...
    public function atualizar() {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if (!in_array($produtoPost['slug'], $produtosSlugs)) {
                ...
                return redirect()->back()
                                ->with('fraude', 'Não conseguimos processar a sua solicitação. Por favor, entre em contato com a nossa equipe e informe o código de erro <strong>ERRO-ATUA-PROD-7007</strong>');
            } else {
