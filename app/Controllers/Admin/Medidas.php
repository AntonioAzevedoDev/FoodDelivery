...
class Medidas extends BaseController {
    ...
    public function editar($id = null) {
        ...
        $data = [
            'titulo' => "Editanto a medida $medida->nome",
            'medida' => $medida,
        ];
    ...
    public function atualizar($id = null) {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($medida->deletado_em != null) {
                return redirect()->back()->with('info', "A medida $medida->nome encontra-se excluida. Portanto, não é possível atualizá-la.");
            }
    ...
    public function excluir($id = null) {
        ...
        if ($medida->deletado_em != null) {
            return redirect()->back()->with('info', "O medida $medida->nome encontra-se excluida.");
        }
