...
class Bairros extends BaseController
{
    ...
    public function cadastrar() {
     ...
     public function editar($id = null) {
        ...
        if ($bairro->deletado_em != null) {
            return redirect()->back()->with('info', "O bairro $bairro->nome encontra-se excluido. Portanto, não é possível editá-lo.");
        }
    ...
    public function atualizar($id = null) {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($bairro->deletado_em != null) {
                return redirect()->back()->with('info', "O bairro $bairro->nome encontra-se excluida. Portanto, não é possível atualizá-lo.");
            }
    ...
    public function excluir($id = null) {
        ...
        if ($bairro->deletado_em != null) {
            return redirect()->back()->with('info', "O bairro $bairro->nome encontra-se excluido.");
        }
